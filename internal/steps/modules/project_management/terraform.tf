  ...
  step {
    ...
    action {
      ...
      properties                         = {
        ...
        "SerializeProject.Exported.Project.IgnoredTenants" = ""
        ...
        "SerializeProject.Exported.Project.OctopusManagedTerraformVars" = "OctoterraWiz.Terraform.Vars"
      }
      environments                       = []
  ...
  step {
    ...
    action {
      ...
      properties                         = {
        ...
        "OctoterraApply.Terraform.AdditionalApplyParams" = "#{if OctoterraWiz.Destination.ProjectName}\"-var=project_#{Octopus.Project.Name | Replace \"[^A-Za-z0-9]\" \"_\" | ToLower}=#{OctoterraWiz.Destination.ProjectName}\"#{/if}"
